...
Issue #23 investigated whether recurring API-container health probes were part of the workload being measured. In one controlled same-runner GitHub Actions A/B investigation, disabling those recurring probes after bounded external readiness produced higher throughput and lower mean latency in all three paired run positions for all four implementations and all three endpoints. Selected throughput differences in that investigation ranged from about +2.3% to +23.1%. The detailed evidence and its limitations are recorded in [the archived 2026-09-09 investigation record](https://github.com/tappe9/simple-api-benchmark/blob/2a515cf8d839d5a81c356f8a1ef0b9e376666d92/docs/investigations/2026-09-09-healthcheck-interference.md).
